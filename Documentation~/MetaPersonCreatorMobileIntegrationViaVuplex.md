# MetaPerson Creator - Integration Into Android And iOS Unity Application Via Vuplex WebView
 ...
 * Import **MetaPerson Creator Mobile Integration Via Vuplex Sample** as well.

![Import Sample](./Images/import_mobile_integration_via_vuplex_sample.jpg "Import Sample")

 * Open the `Assets/Samples/MetaPerson Loader/x.y.z/MetaPerson Creator Mobile Integration Via Vuplex Sample/Scenes/MetaPersonCreatorMobileIntegrationViaVuplexSample.unity` scene.

### Get the sample from the repository.

 * Clone this repository to your computer.

 * Open the project from `metaperson-loader-unity\Samples~\MetaPersonCreatorMobileIntegrationViaVuplexSample` directory in Unity 2021.3.19f1 or a newer.

 * Open the `Assets/AvatarSDK/MetaPerson/MobileIntegrationViaVuplexSample/Scenes/MetaPersonCreatorMobileIntegrationViaVuplexSample.unity` scene.
